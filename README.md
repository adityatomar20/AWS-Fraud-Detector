...
For this project, We trained a model on an Amazon Fraud detector and ran it through some test data coming through a custom-built website. 

<h2>How it works</h2>

1.	Upload your training data onto S3
...
4.	Take the model at that point, add it to a detector, and combine it with appropriate rules that are most important
...
Amazon Fraud detector takes care of all the heavy lifting like Data Validation, Data Enrichment, and transformation (e.g. adding geolocation data to IP addresses) and feature engineering based on Amazon’s research and ML experts. 
...
13.	Add your model to the detector
14.	Set business rules for your outcome prediction
15.	Review the configuration and publish your detector
...
After finishing setting credentials, you can connect the Amazon fraud detector through "import boto3" in your jupyter notebook.
